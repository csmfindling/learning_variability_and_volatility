...
static PyObject *__pyx_pf_5smc_c_bootstrapUpdateStep_c(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_currentStateRes, PyArrayObject *__pyx_v_logThetaWeights, PyArrayObject *__pyx_v_currentTauRes, PyArrayObject *__pyx_v_gammaList, PyArrayObject *__pyx_v_betaList, PyArrayObject *__pyx_v_nuList, double __pyx_v_tauDefault, int __pyx_v_t, PyArrayObject *__pyx_v_ancestorsStateList, PyArrayObject *__pyx_v_ancestorsTauList, PyArrayObject *__pyx_v_weightsList, PyArrayObject *__pyx_v_mapping, int __pyx_v_currentStimulus, int __pyx_v_action, int __pyx_v_reward); /* proto */
...
static char __pyx_k_Users_csmfindling_Documents_CDD[] = "/Users/csmfindling/Documents/CDD/CDD_ScienceCog_Ulm/Models/Simulations/code/marginalisation/var_vol/forward/varvol_model/SMCfunctions_py.pyx";
...
static PyObject *__pyx_pw_5smc_c_1bootstrapUpdateStep_c(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_currentStateRes,&__pyx_n_s_logThetaWeights,&__pyx_n_s_currentTauRes,&__pyx_n_s_gammaList,&__pyx_n_s_betaList,&__pyx_n_s_nuList,&__pyx_n_s_tauDefault,&__pyx_n_s_t,&__pyx_n_s_ancestorsStateList,&__pyx_n_s_ancestorsTauList,&__pyx_n_s_weightsList,&__pyx_n_s_mapping,&__pyx_n_s_currentStimulus,&__pyx_n_s_action,&__pyx_n_s_reward,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_logThetaWeights)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_currentTauRes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_gammaList)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_betaList)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nuList)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tauDefault)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_t)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 7); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ancestorsStateList)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 8); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ancestorsTauList)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 9); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_weightsList)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 10); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 11:
        if (likely((values[11] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mapping)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 11); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 12:
        if (likely((values[12] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_currentStimulus)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 12); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 13:
        if (likely((values[13] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_action)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 13); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 14:
        if (likely((values[14] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_reward)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, 14); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "bootstrapUpdateStep_c") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_currentTauRes = ((PyArrayObject *)values[2]);
    __pyx_v_gammaList = ((PyArrayObject *)values[3]);
    __pyx_v_betaList = ((PyArrayObject *)values[4]);
    __pyx_v_nuList = ((PyArrayObject *)values[5]);
    __pyx_v_tauDefault = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_tauDefault == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_t = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_t == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_ancestorsStateList = ((PyArrayObject *)values[8]);
    __pyx_v_ancestorsTauList = ((PyArrayObject *)values[9]);
    __pyx_v_weightsList = ((PyArrayObject *)values[10]);
    __pyx_v_mapping = ((PyArrayObject *)values[11]);
    __pyx_v_currentStimulus = __Pyx_PyInt_As_int(values[12]); if (unlikely((__pyx_v_currentStimulus == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    ...
    __pyx_v_reward = __Pyx_PyInt_As_int(values[14]); if (unlikely((__pyx_v_reward == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("bootstrapUpdateStep_c", 1, 15, 15, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_currentTauRes), __pyx_ptype_5numpy_ndarray, 0, "currentTauRes", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_nuList), __pyx_ptype_5numpy_ndarray, 0, "nuList", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_ancestorsStateList), __pyx_ptype_5numpy_ndarray, 0, "ancestorsStateList", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_5smc_c_bootstrapUpdateStep_c(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_currentStateRes, PyArrayObject *__pyx_v_logThetaWeights, PyArrayObject *__pyx_v_currentTauRes, PyArrayObject *__pyx_v_gammaList, PyArrayObject *__pyx_v_betaList, PyArrayObject *__pyx_v_nuList, double __pyx_v_tauDefault, int __pyx_v_t, PyArrayObject *__pyx_v_ancestorsStateList, PyArrayObject *__pyx_v_ancestorsTauList, PyArrayObject *__pyx_v_weightsList, PyArrayObject *__pyx_v_mapping, int __pyx_v_currentStimulus, int __pyx_v_action, int __pyx_v_reward) {
  int __pyx_v_K;
 ...
 *                             np.ndarray[double, ndim=2, mode="c"] ancestorsTauList not None, np.ndarray[double, ndim=2, mode="c"] weightsList not None, np.ndarray[int, ndim=2, mode="c"] mapping not None, int currentStimulus, int action, int reward):
 */
  __pyx_tuple__7 = PyTuple_Pack(19, __pyx_n_s_currentStateRes, __pyx_n_s_logThetaWeights, __pyx_n_s_currentTauRes, __pyx_n_s_gammaList, __pyx_n_s_betaList, __pyx_n_s_nuList, __pyx_n_s_tauDefault, __pyx_n_s_t, __pyx_n_s_ancestorsStateList, __pyx_n_s_ancestorsTauList, __pyx_n_s_weightsList, __pyx_n_s_mapping, __pyx_n_s_currentStimulus, __pyx_n_s_action, __pyx_n_s_reward, __pyx_n_s_K, __pyx_n_s_numberOfStimuli, __pyx_n_s_numberOfStateSamples, __pyx_n_s_numberOfThetaSamples); if (unlikely(!__pyx_tuple__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(15, 0, 19, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_csmfindling_Documents_CDD, __pyx_n_s_bootstrapUpdateStep_c, 28, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *                             np.ndarray[double, ndim=2, mode="c"] ancestorsTauList not None, np.ndarray[double, ndim=2, mode="c"] weightsList not None, np.ndarray[int, ndim=2, mode="c"] mapping not None, int currentStimulus, int action, int reward):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5smc_c_1bootstrapUpdateStep_c, NULL, __pyx_n_s_smc_c); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_bootstrapUpdateStep_c, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
