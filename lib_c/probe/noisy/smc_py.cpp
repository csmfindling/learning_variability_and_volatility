...
static const char __pyx_k_nTrials[] = "nTrials";
static const char __pyx_k_rewards[] = "rewards";
static const char __pyx_k_act_corr[] = "act_corr";
static const char __pyx_k_stim_seq[] = "stim_seq";
static const char __pyx_k_N_samples[] = "N_samples";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_trap_trials[] = "trap_trials";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_bootstrap_smc_c[] = "bootstrap_smc_c";
static const char __pyx_k_output_probabilities[] = "output_probabilities";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_Users_csmfindling_Documents_CDD[] = "/Users/csmfindling/Documents/CDD/CDD_ScienceCog_Ulm/volatility/models/lib_c/probe/noisy/smc_py.pyx";
...
static PyObject *__pyx_n_s_act_corr;
static PyObject *__pyx_n_s_act_seq;
static PyObject *__pyx_n_s_bootstrap_smc_c;
static PyObject *__pyx_n_s_import;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_nA;
static PyObject *__pyx_n_s_nC;
static PyObject *__pyx_n_s_nS;
static PyObject *__pyx_n_s_nTrials;
static PyObject *__pyx_kp_u_ndarray_is_not_C_contiguous;
static PyObject *__pyx_kp_u_ndarray_is_not_Fortran_contiguou;
static PyObject *__pyx_n_s_np;
static PyObject *__pyx_n_s_numpy;
static PyObject *__pyx_n_s_output_probabilities;
static PyObject *__pyx_n_s_params;
static PyObject *__pyx_n_s_range;
static PyObject *__pyx_n_s_rewards;
static PyObject *__pyx_n_s_smc_c;
static PyObject *__pyx_n_s_stim_seq;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_n_s_trap_trials;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_pf_5smc_c_bootstrap_smc_c(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_N_samples, int __pyx_v_nS, int __pyx_v_nC, PyArrayObject *__pyx_v_stim_seq, PyArrayObject *__pyx_v_act_seq, PyArrayObject *__pyx_v_rewards, PyArrayObject *__pyx_v_act_corr, PyArrayObject *__pyx_v_trap_trials, PyArrayObject *__pyx_v_params, int __pyx_v_nA, int __pyx_v_nTrials, PyArrayObject *__pyx_v_output_probabilities); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_5smc_c_1bootstrap_smc_c(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_5smc_c_1bootstrap_smc_c = {"bootstrap_smc_c", (PyCFunction)__pyx_pw_5smc_c_1bootstrap_smc_c, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5smc_c_1bootstrap_smc_c(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_N_samples;
  int __pyx_v_nS;
  int __pyx_v_nC;
  PyArrayObject *__pyx_v_stim_seq = 0;
  PyArrayObject *__pyx_v_act_seq = 0;
  PyArrayObject *__pyx_v_rewards = 0;
  PyArrayObject *__pyx_v_act_corr = 0;
  PyArrayObject *__pyx_v_trap_trials = 0;
  PyArrayObject *__pyx_v_params = 0;
  int __pyx_v_nA;
  int __pyx_v_nTrials;
  PyArrayObject *__pyx_v_output_probabilities = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("bootstrap_smc_c (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_N_samples,&__pyx_n_s_nS,&__pyx_n_s_nC,&__pyx_n_s_stim_seq,&__pyx_n_s_act_seq,&__pyx_n_s_rewards,&__pyx_n_s_act_corr,&__pyx_n_s_trap_trials,&__pyx_n_s_params,&__pyx_n_s_nA,&__pyx_n_s_nTrials,&__pyx_n_s_output_probabilities,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nS)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nC)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, 2); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_stim_seq)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, 3); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_act_seq)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, 4); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_rewards)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, 5); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_act_corr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, 6); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_trap_trials)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, 7); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_params)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, 8); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nA)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, 9); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nTrials)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, 10); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        case 11:
        if (likely((values[11] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_output_probabilities)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, 11); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "bootstrap_smc_c") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    ...
    __pyx_v_N_samples = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_N_samples == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_nS = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_nS == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_nC = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_nC == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_stim_seq = ((PyArrayObject *)values[3]);
    __pyx_v_act_seq = ((PyArrayObject *)values[4]);
    __pyx_v_rewards = ((PyArrayObject *)values[5]);
    __pyx_v_act_corr = ((PyArrayObject *)values[6]);
    __pyx_v_trap_trials = ((PyArrayObject *)values[7]);
    __pyx_v_params = ((PyArrayObject *)values[8]);
    __pyx_v_nA = __Pyx_PyInt_As_int(values[9]); if (unlikely((__pyx_v_nA == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_nTrials = __Pyx_PyInt_As_int(values[10]); if (unlikely((__pyx_v_nTrials == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_output_probabilities = ((PyArrayObject *)values[11]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("bootstrap_smc_c", 1, 12, 12, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("smc_c.bootstrap_smc_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_stim_seq), __pyx_ptype_5numpy_ndarray, 0, "stim_seq", 0))) __PYX_ERR(0, 11, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_act_seq), __pyx_ptype_5numpy_ndarray, 0, "act_seq", 0))) __PYX_ERR(0, 11, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_rewards), __pyx_ptype_5numpy_ndarray, 0, "rewards", 0))) __PYX_ERR(0, 12, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_act_corr), __pyx_ptype_5numpy_ndarray, 0, "act_corr", 0))) __PYX_ERR(0, 12, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_trap_trials), __pyx_ptype_5numpy_ndarray, 0, "trap_trials", 0))) __PYX_ERR(0, 13, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_params), __pyx_ptype_5numpy_ndarray, 0, "params", 0))) __PYX_ERR(0, 13, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_output_probabilities), __pyx_ptype_5numpy_ndarray, 0, "output_probabilities", 0))) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_r = __pyx_pf_5smc_c_bootstrap_smc_c(__pyx_self, __pyx_v_N_samples, __pyx_v_nS, __pyx_v_nC, __pyx_v_stim_seq, __pyx_v_act_seq, __pyx_v_rewards, __pyx_v_act_corr, __pyx_v_trap_trials, __pyx_v_params, __pyx_v_nA, __pyx_v_nTrials, __pyx_v_output_probabilities);
...
static PyObject *__pyx_pf_5smc_c_bootstrap_smc_c(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_N_samples, int __pyx_v_nS, int __pyx_v_nC, PyArrayObject *__pyx_v_stim_seq, PyArrayObject *__pyx_v_act_seq, PyArrayObject *__pyx_v_rewards, PyArrayObject *__pyx_v_act_corr, PyArrayObject *__pyx_v_trap_trials, PyArrayObject *__pyx_v_params, int __pyx_v_nA, int __pyx_v_nTrials, PyArrayObject *__pyx_v_output_probabilities) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_act_corr;
  __Pyx_Buffer __pyx_pybuffer_act_corr;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_act_seq;
  __Pyx_Buffer __pyx_pybuffer_act_seq;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_output_probabilities;
  __Pyx_Buffer __pyx_pybuffer_output_probabilities;
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_stim_seq;
  __Pyx_Buffer __pyx_pybuffer_stim_seq;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_trap_trials;
  __Pyx_Buffer __pyx_pybuffer_trap_trials;
  ...
  __Pyx_RefNannySetupContext("bootstrap_smc_c", 0);
  __pyx_pybuffer_stim_seq.pybuffer.buf = NULL;
  __pyx_pybuffer_stim_seq.refcount = 0;
  __pyx_pybuffernd_stim_seq.data = NULL;
  __pyx_pybuffernd_stim_seq.rcbuffer = &__pyx_pybuffer_stim_seq;
  __pyx_pybuffer_act_seq.pybuffer.buf = NULL;
  __pyx_pybuffer_act_seq.refcount = 0;
  __pyx_pybuffernd_act_seq.data = NULL;
  __pyx_pybuffernd_act_seq.rcbuffer = &__pyx_pybuffer_act_seq;
  ...
  __pyx_pybuffer_act_corr.pybuffer.buf = NULL;
  __pyx_pybuffer_act_corr.refcount = 0;
  __pyx_pybuffernd_act_corr.data = NULL;
  __pyx_pybuffernd_act_corr.rcbuffer = &__pyx_pybuffer_act_corr;
  __pyx_pybuffer_trap_trials.pybuffer.buf = NULL;
  __pyx_pybuffer_trap_trials.refcount = 0;
  __pyx_pybuffernd_trap_trials.data = NULL;
  __pyx_pybuffernd_trap_trials.rcbuffer = &__pyx_pybuffer_trap_trials;
  ...
  __pyx_pybuffer_output_probabilities.pybuffer.buf = NULL;
  __pyx_pybuffer_output_probabilities.refcount = 0;
  __pyx_pybuffernd_output_probabilities.data = NULL;
  __pyx_pybuffernd_output_probabilities.rcbuffer = &__pyx_pybuffer_output_probabilities;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_stim_seq.rcbuffer->pybuffer, (PyObject*)__pyx_v_stim_seq, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  __pyx_pybuffernd_stim_seq.diminfo[0].strides = __pyx_pybuffernd_stim_seq.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_stim_seq.diminfo[0].shape = __pyx_pybuffernd_stim_seq.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_act_seq.rcbuffer->pybuffer, (PyObject*)__pyx_v_act_seq, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  __pyx_pybuffernd_act_seq.diminfo[0].strides = __pyx_pybuffernd_act_seq.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_act_seq.diminfo[0].shape = __pyx_pybuffernd_act_seq.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_rewards.rcbuffer->pybuffer, (PyObject*)__pyx_v_rewards, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_act_corr.rcbuffer->pybuffer, (PyObject*)__pyx_v_act_corr, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  __pyx_pybuffernd_act_corr.diminfo[0].strides = __pyx_pybuffernd_act_corr.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_act_corr.diminfo[0].shape = __pyx_pybuffernd_act_corr.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_trap_trials.rcbuffer->pybuffer, (PyObject*)__pyx_v_trap_trials, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  __pyx_pybuffernd_trap_trials.diminfo[0].strides = __pyx_pybuffernd_trap_trials.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_trap_trials.diminfo[0].shape = __pyx_pybuffernd_trap_trials.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_params.rcbuffer->pybuffer, (PyObject*)__pyx_v_params, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_output_probabilities.rcbuffer->pybuffer, (PyObject*)__pyx_v_output_probabilities, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  __pyx_pybuffernd_output_probabilities.diminfo[0].strides = __pyx_pybuffernd_output_probabilities.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_output_probabilities.diminfo[0].shape = __pyx_pybuffernd_output_probabilities.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_output_probabilities.diminfo[1].strides = __pyx_pybuffernd_output_probabilities.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_output_probabilities.diminfo[1].shape = __pyx_pybuffernd_output_probabilities.rcbuffer->pybuffer.shape[1];
 ...
 */
  ...
  __pyx_t_7 = 0;
  __pyx_t_8 = 0;
  __pyx_t_9 = PyFloat_FromDouble(smc::bootstrap_smc(__pyx_v_N_samples, __pyx_v_nS, __pyx_v_nC, (&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_stim_seq.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_stim_seq.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_act_seq.rcbuffer->pybuffer.buf, __pyx_t_2, __pyx_pybuffernd_act_seq.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_rewards.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_rewards.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_act_corr.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_act_corr.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_trap_trials.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_trap_trials.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_params.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_params.diminfo[0].strides))), __pyx_v_nA, __pyx_v_nTrials, (&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_output_probabilities.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_output_probabilities.diminfo[0].strides, __pyx_t_8, __pyx_pybuffernd_output_probabilities.diminfo[1].strides))))); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 14, __pyx_L1_error)
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_act_corr.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_act_seq.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output_probabilities.rcbuffer->pybuffer);
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_stim_seq.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_trap_trials.rcbuffer->pybuffer);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_act_corr, __pyx_k_act_corr, sizeof(__pyx_k_act_corr), 0, 0, 1, 1},
  {&__pyx_n_s_act_seq, __pyx_k_act_seq, sizeof(__pyx_k_act_seq), 0, 0, 1, 1},
  {&__pyx_n_s_bootstrap_smc_c, __pyx_k_bootstrap_smc_c, sizeof(__pyx_k_bootstrap_smc_c), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_nTrials, __pyx_k_nTrials, sizeof(__pyx_k_nTrials), 0, 0, 1, 1},
  {&__pyx_kp_u_ndarray_is_not_C_contiguous, __pyx_k_ndarray_is_not_C_contiguous, sizeof(__pyx_k_ndarray_is_not_C_contiguous), 0, 1, 0, 0},
  {&__pyx_kp_u_ndarray_is_not_Fortran_contiguou, __pyx_k_ndarray_is_not_Fortran_contiguou, sizeof(__pyx_k_ndarray_is_not_Fortran_contiguou), 0, 1, 0, 0},
  {&__pyx_n_s_np, __pyx_k_np, sizeof(__pyx_k_np), 0, 0, 1, 1},
  {&__pyx_n_s_numpy, __pyx_k_numpy, sizeof(__pyx_k_numpy), 0, 0, 1, 1},
  {&__pyx_n_s_output_probabilities, __pyx_k_output_probabilities, sizeof(__pyx_k_output_probabilities), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_stim_seq, __pyx_k_stim_seq, sizeof(__pyx_k_stim_seq), 0, 0, 1, 1},
  {&__pyx_n_s_test, __pyx_k_test, sizeof(__pyx_k_test), 0, 0, 1, 1},
  {&__pyx_n_s_trap_trials, __pyx_k_trap_trials, sizeof(__pyx_k_trap_trials), 0, 0, 1, 1},
 ...
 *                     np.ndarray[int, ndim=1, mode="c"] trap_trials not None, np.ndarray[double, ndim=1, mode="c"] params not None, int nA, int nTrials, np.ndarray[double, ndim=2, mode="c"] output_probabilities not None):
 */
  __pyx_tuple__7 = PyTuple_Pack(12, __pyx_n_s_N_samples, __pyx_n_s_nS, __pyx_n_s_nC, __pyx_n_s_stim_seq, __pyx_n_s_act_seq, __pyx_n_s_rewards, __pyx_n_s_act_corr, __pyx_n_s_trap_trials, __pyx_n_s_params, __pyx_n_s_nA, __pyx_n_s_nTrials, __pyx_n_s_output_probabilities); if (unlikely(!__pyx_tuple__7)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(12, 0, 12, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_csmfindling_Documents_CDD, __pyx_n_s_bootstrap_smc_c, 11, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *                     np.ndarray[int, ndim=1, mode="c"] trap_trials not None, np.ndarray[double, ndim=1, mode="c"] params not None, int nA, int nTrials, np.ndarray[double, ndim=2, mode="c"] output_probabilities not None):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5smc_c_1bootstrap_smc_c, NULL, __pyx_n_s_smc_c); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_bootstrap_smc_c, __pyx_t_1) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
